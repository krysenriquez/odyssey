...
class Settings(models.TextChoices):
    ...
    B_WALLET_MINIMUM_CASHOUT_AMOUNT = "B_WALLET_MINIMUM_CASHOUT_AMOUNT", _("Binary Wallet Minimum Cashout Amount")
    ...
    F_WALLET_MINIMUM_CASHOUT_AMOUNT = "F_WALLET_MINIMUM_CASHOUT_AMOUNT", _("Franchise Wallet Minimum Cashout Amount")
    ...
    GC_WALLET_MINIMUM_CASHOUT_AMOUNT = "GC_WALLET_MINIMUM_CASHOUT_AMOUNT", _("Gift Certificate Wallet Minimum Cashout Amount")
